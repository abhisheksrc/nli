...
The quantitative performance of the Neural models on each label is shown here:

| - | label | Size | Similarity (0.0 - 5.0) | BLEU (0.0 - 1.0) |
|-|-|-|-|-|
| Dev | *entailment* | 3.3k | 2.34 | 0.29 |
...
|-|-|-|
| I am going to Europe. | I will be travelling in Rome. | *entailment*, or *neutral*, or *contradiction* ?|
